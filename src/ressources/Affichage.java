...
public class Affichage {
	...
	/**
	 * Cette fonction permet d'afficher l'image adapt�e au PV de la propriete
	 * @param pv de l'unite ou de la propriete
	 * @param propriete true si c'est une propriete sinon false
	 */
	public static void affichePV(int x, int y, double pv, boolean propriete) {
		int PV = (int) Math.ceil(pv);
		switch(PV) {
			case (1) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_UN));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_UNG));
				break;
			case (2) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DEUX));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DEUXG));
				break;
			case (3) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_TROIS));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_TROISG));
				break;
			case (4) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_QUATRE));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_QUATREG));
				break;
			case (5) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_CINQ));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_CINQG));
				break;
			case (6) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_SIX));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_SIXG));
				break;
			case (7) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_SEPT));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_SEPTG));
				break;
			case (8) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_HUIT));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_HUITG));
				break;
			case (9) : 
				if(propriete)Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_NEUF));
				else Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_NEUFG));
				break;
			case (10) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DIX));
				break;
			case (11) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_ONZE));
				break;
			case (12) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DOUZE));
				break;
			case (13) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_TREIZE));
				break;
			case (14) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_QUATORZE));
				break;
			case (15) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_QUINZE));
				break;
			case (16) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_SEIZE));
				break;
			case (17) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DIXSEPT));
				break;
			case (18) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DIXHUIT));
				break;
			case (19) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_DIXNEUF));
				break;
			case (20) : 
				if(propriete) Affichage.dessineImageDansCase(x, y, Chemins.getCheminVie(Chemins.FICHIER_VINGT));
				break;
    ...
    /**
     * Donne l'abscisse correspondant a <code>x</code> dans le referentiel du rectangle: par exemple, <code>x=0.0</code> -> gauche du rectangle, <code>x = 1.0</code> -> droite du rectangle.
 ...
 */ 
   public static void dessineImageDansCase(int x, int y, String cheminImage) {
	   y = Config.longueurCarteYCases-y-1; // XXX modification pour affichage normal
...
/**
 * Affiche un texte sur une seule ligne dans la zone situee au-dessus de la carte.
